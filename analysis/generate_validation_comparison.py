...
from model.plotutils import setup_publication_style
...
rects1 = ax.bar(x - WIDTH / 2, mae_vals,  WIDTH, label="MAE",
                color=COLOR_MAE,  edgecolor="#1a1a1a", linewidth=0.8)
rects2 = ax.bar(x + WIDTH / 2, rmse_vals, WIDTH, label="RMSE",
                color=COLOR_RMSE, edgecolor="#1a1a1a", linewidth=0.8)
...
rects1 = ax.bar(x - WIDTH / 2, mape_vals,  WIDTH, label="MAPE (%)",
                color=COLOR_MAPE,  edgecolor="#1a1a1a", linewidth=0.8)
rects2 = ax.bar(x + WIDTH / 2, pbias_vals, WIDTH, label="PBIAS (%)",
                color=COLOR_PBIAS, edgecolor="#1a1a1a", linewidth=0.8)
